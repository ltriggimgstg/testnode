...
module.exports = [
    ...
    { method: 'PUT', path: '/Account/{accountId}/UpdatePersonalInfo', config: Account.updatePersonalInfo},
    ...
    { method: 'GET', path: '/AuthCache/Login', config: AuthCache.login},
    { method: 'GET', path: '/SFPersonalInfo/{token}/Member/{memberId}/GetPersonalInfo', config: SFPersonalInfo.getPersonalInfo},
    { method: 'GET', path: '/SFPersonalInfo/{accountId}/RelatedMemberships', config: Account.getLinkedMembers},
    { method: 'GET', path: '/Picklists/GetCountries', config: Picklists.getCountries},
    { method: 'GET', path: '/Picklists/GetGender', config: Picklists.getGender},
    { method: 'GET', path: '/Picklists/GetProvinces/{countryCode}', config: Picklists.getProvinces},
];
